import cx_Oracle
try:
            con=cx_Oracle.connect("system/baba@localhost/xe")
            cur=con.cursor()
            ...
            class Customer:
                        ...
                        def signUp(self,acctyp,name,gender,mob,addr,state,city,pincode,email,password,balance):
                                    cur.execute("""INSERT INTO  amit.customer VALUES (amit.C_ID_VAL.NEXTVAL,:pram0,:pram1,:pram2,:pram3,:pram4,:pram5,:pram6,:pram7
                                         ,:pram8,:pram9,:pram10,'0',SYSDATE)""",(acctyp,name,gender,mob,addr,state,city,pincode,email,password,balance))
                                    con.commit()
                                    ...
                                    if self.num==1:
                                                ...
                                                while True:
                                                            if c>=1 and c<=3:
                                                                        ...
                                                                        cur.execute("INSERT INTO amit.printhistory(:1,SYSDATE)",(self.customerId))
                                                                        con.commit()
                                                                        cur.execute("DELETE FROM amit.customer WHERE customer_id=:1",(self.customer_Id))
                                                                        con.commit()
                                                                        break;
